...
In this chapter we describe a Cypress plugin that we created to simplify testing of Trusted Types in
web applications. This plugin is created from scratch, verified with many tests and also used to
test the real world application written in Solid.js from the previous chapter.
