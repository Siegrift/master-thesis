...
rest of the chapter explains our integrations. The first one is an JSX Babel plugin for Solid.js
framework. The next one is a Vite integration to support development mode of applications. These are
the two core integrations that provide the support for development of Trusted Types compliant
applications in Solid.js framework.
